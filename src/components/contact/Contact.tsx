        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <a
              ...
              download
              className="mt-5 inline-flex items-center gap-2 py-3 clip-corner-tr gradient-bg text-white font-medium shadow-lg shadow-primary/30 hover:shadow-primary/50 hover:scale-[1.02] transition-all duration-300"
            >
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="glass rounded-2xl border border-border p-6 space-y-4">
              ...
              <button
                ...
                className="w-full py-3 clip-corner-tr gradient-bg text-white font-medium shadow-lg shadow-primary/30 hover:shadow-primary/50 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {status === 'sending'
                  ? 'Sending…'
                  : status === 'sent'
